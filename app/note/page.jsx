...
const messageLines = [
  ...
  "You make everything lighter, happier, and better.",
  "On your special day, I hope you smile a little extra 😊",
...
export default function NotePage() {
  ...
  return (
    <main style={styles.container}>
      <motion.h1
        animate={{ opacity: isOpen ? 0.5 : 1, scale: isOpen ? 0.95 : 1 }}
        style={styles.header}
      >
